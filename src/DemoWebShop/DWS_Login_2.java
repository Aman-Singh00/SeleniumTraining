...
public class DWS_Login_2 {
	...
	public static void main(String[] args) {
		...
		//identify the username provide without registered email id
		driver.findElement(By.xpath("//input[@class='email']")).sendKeys("amansingh@gmail.com");
		
		//identify the username provide without registered password.
